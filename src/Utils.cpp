...
int Utils::getDepartmentCode(const string& department) {
    ...
    if (dept_lower == "it") return 1;
    if (dept_lower == "hr") return 2;
    if (dept_lower == "finance") return 3;
    if (dept_lower == "operations") return 4;
    if (dept_lower == "cse") return 5;
    if (dept_lower == "civil") return 6;
    if (dept_lower == "mechanical") return 7;
    if (dept_lower == "electrical") return 8;
    if (dept_lower == "sales") return 9;
...
int Utils::generateSmartEmployeeId(const string& department, int joining_year) {
    ...
    if (dept_code == 0) dept_code = 9; // Default code for unknown departments
